      ...
      <div className="p-6 space-y-4">
        ...
        <div className="space-y-2">
          ...
          >
            <div className="flex items-start gap-3">
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                selectedScanType === 'total' ? 'bg-emerald-800' : 'bg-gray-400'
              }`}>
                <Lightning weight="regular" className="w-5 h-5 text-white" />
              </div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-1">Total Scanning</h3>
                <p className="text-sm text-gray-600">
          ...
          >
            <div className="flex items-start gap-3">
              <div className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                selectedScanType === 'summary' ? 'bg-emerald-800' : 'bg-gray-400'
              }`}>
                <MapPin weight="regular" className="w-5 h-5 text-white" />
              </div>
              <div className="flex-1">
                <h3 className="font-semibold text-gray-900 mb-1">Summary Scanning</h3>
                <p className="text-sm text-gray-600">
                  Extracts &quot;Irrigation Association&quot; names and &quot;Total Area&quot; values from specific pages.
                  Creates a grid view of irrigation associations.
                </p>
              </div>
            </div>
          </div>
